...
#define cpu_is_apm4460()		0
#define cpu_is_in_rsa_mode()            0
...
# undef cpu_is_apm4460
static inline bool cpu_is_apm4460 (void)
{
	extern bool jorjin_4460_ap_module;
	return jorjin_4460_ap_module;
}

#undef cpu_is_in_rsa_mode
static inline bool cpu_is_in_rsa_mode(void)
{
	extern bool jorjin_raccoon_stand_alone;
	return jorjin_raccoon_stand_alone;
}
# endif
# endif
